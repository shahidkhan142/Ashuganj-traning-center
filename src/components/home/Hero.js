  ...
  return (
    <div className="hero py-12 bg-gradient-to-t from-blue-500 to-purple-700">
      <div className="hero-content md:px-0 px-4 max-w-6xl flex-col lg:flex-row-reverse">
        ...
        <div>
          <h1 className="text-5xl text-slate-100 font-bold md:leading-none leading-tight md:mt-0 mt-10">ASHUGANJ TRANING  <span className="md:block mt-4">CENTER</span></h1>
          <p className="py-2 text-xl text-slate-100 mt-4 pr-12">GET YOUR CAREER CHANGING TRANING <br />FROM US.</p>
